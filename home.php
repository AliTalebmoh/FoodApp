...
<section class="products">
   ...
   <?php
   // Fetch the first 6 products with their category name
...
<form action="" method="post" class="box">
   ...
   <!-- Use category_name fetched from the join -->
   <a href="category.php?category=<?= urlencode($fetch_products['category_name']); ?>" class="cat"><?= htmlspecialchars($fetch_products['category_name']); ?></a>
